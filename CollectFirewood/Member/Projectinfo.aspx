        ...
        <div class="middle">
           ...
           <div class="projectinfobox grid">
               ...
               <div class="projectinfobox-left">
                    <h2>项目名称</h2>
                    <span style="background-color: tomato;width: 60px;text-align: center;color: white;border-radius: 5px;margin-left: 60px;height: 25px;line-height: 25px;">发起人</span>
                    <span class="projectinfobox-people">发起人姓名</span>
                    <span class="projectinfobox-address">地址</span>
               </div>
               <!-- 右边 -->
               <div class="projectinfobox-right">
                    ...
                    <div class="returnbox" style="height: 300px;">
                        ...
                        <h1>￥138000</h1>
                        <br>
                        <div><span>此项目必须在<span style="color: orange;">2014年10月13日</span>前得到<span style="color:orange">￥15000</span>的支持才算成功</span></div>
                        <br>
                        <progress value="93" max="100" style="display: block;height: 60px;"></progress>
                        <br>
                        <table  cellspace="1">
                            <tr>
                                <td>进度</td>
                    ...
                    <div class="returnbox" style="color: grey;">
                        <span">支持￥300</span><span style="float:right;">已有<span style="color: orange;">2</span>位支持者</span>   
                        <br>  
