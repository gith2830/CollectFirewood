<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupportProjects.aspx.cs" Inherits="CollectFirewood.Manager.Components.SupportProjects" %>
...
<body>
                ...
                <div class="card__table-box">
                    <table cellspacing="0" cellpadding="0">
                        <tr class="table-header">
                            ...
                            <td bind="Money">支持的数额</td>
                            <td bind="Id" onDelete="deleteSupportProject" onEdit="showEditDialog">操作</td>
                        </tr>
                    </table>
                </div>
                <ul class="page-box">
        ...
        <div class="editDialog dialog-box">
            ...
            <div class="dialog-box__content">
                <table>
                    ...
                    <tr class="input-item"><td><span class="label-item">支持数额:</span></td><td><input type="number" class="input-text edit-money"/></td></tr>
                </table>
                <div class="btnBox">
                    <button class="button btn_huge btn_append" type="button" onclick="editSupportProject()">修改</button>
    ...
    <script>
        ...
        function deleteSupportProject(obj, id) {
            $.ajax({
                type: "post",
                url: "/Ashx/Project/SupportProjectAction.ashx",
